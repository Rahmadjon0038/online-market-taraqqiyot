...
const page = () => {
    const data = [
        { label: ' Yetkazilgan', value: 400, color: '#77ea04' },
        { label: 'Yangi', value: 300, color: '#1c09f1' },
        { label: 'Tasdiqlangan', value: 300, color: '#f9bb0f' },
    ];
    ...
    const props = {
        height: 300,
        xAxis: [{ data: ['Bolalar kiyimlari', 'Ayollar kiyimlari', 'Sport kiyimlari'] }],
        yAxis: [{ width: 50 }],
    };
    ...
    return (
        <>
            <div className="px-12 py-12 px-24">
                ...
                <p className="text-xl">Do'kon bo'yicha umumiy ko'rinish
                </p>

                <div className=" my-12 grid grid-cols-4 gap-6">
                    {
                        statistika?.map((item) => (
                            <div className="bg-white p-6 rounded-xl border border-gray-300 space-y-4" key={item.key}>
                ...
                <div className=" my-12 flex   gap-6">
                    ...
                    <div className='bg-white w-[400px] p-6 border rounded-xl border-gray-200'>
                        <PieChart
                    ...
                    <div className='bg-white p-6 border rounded-xl border-gray-200 flex-1'>
